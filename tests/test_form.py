...
def test_form():
    ...
    form.set_subjects(subject_english, subject_arts)
    form.set_hobbie(hobbie_music, hobbie_sports)
    ...
    final_table(5, 'English, Arts').result_assert()
    final_table(6, 'Music, Sports').result_assert()
